...
func initImageConfigs() map[int]Config {
	...
	configs[CRDConversionWebhook] = Config{e2eRegistry, "crd-conversion-webhook", "1.13rev3"}
	...
	configs[AuditProxy] = Config{e2eRegistry, "audit-proxy", "1.2"}
	...
	configs[CudaVectorAdd2] = Config{e2eRegistry, "cuda-vector-add", "2.1"}
	...
	configs[EntrypointTester] = Config{e2eRegistry, "entrypoint-tester", "1.1"}
	configs[Etcd] = Config{gcRegistry, "etcd", "3.3.10"}
	configs[GBFrontend] = Config{sampleRegistry, "gb-frontend", "v6"}
	configs[GBRedisSlave] = Config{sampleRegistry, "gb-redisslave", "v3"}
	configs[InClusterClient] = Config{e2eRegistry, "inclusterclient", "1.1"}
	...
	configs[Iperf] = Config{e2eRegistry, "iperf", "1.1"}
	...
	configs[Porter] = Config{e2eRegistry, "porter", "1.1"}
	...
	configs[ServeHostname] = Config{e2eRegistry, "serve-hostname", "1.3"}
