...
```yaml
    ...
    spec:
      ...
      - args:
        - dns-suffix
        image: gcr.io/kubernetes-e2e-test-images/agnhost:2.11
        name: agnhost
      dnsConfig:
        nameservers:
        - 1.1.1.1
...
sed_expr="s|{{.AgnhostImage}}|gcr.io/kubernetes-e2e-test-images/agnhost:2.11|"
...
```console
docker run -i \
  gcr.io/kubernetes-e2e-test-images/agnhost:2.11 \
...
The image can be found at `gcr.io/kubernetes-e2e-test-images/agnhost:2.11` for both Linux and
