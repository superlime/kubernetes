...
sed_expr="s|{{.AgnhostImage}}|us.gcr.io/k8s-artifacts-prod/e2e-test-images/agnhost:2.13|"
...
The image can be found at `us.gcr.io/k8s-artifacts-prod/e2e-test-images/agnhost:2.13` for both Linux and
