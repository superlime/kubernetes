...
// CmdGenerateLogs is used by agnhost Cobra.
var CmdGenerateLogs = &cobra.Command{
	Use:   "generate-logs",
...
func init() {
	CmdGenerateLogs.Flags().IntVarP(&linesTotal, "log-lines-total", "t", 0, "Total lines that should be generated by the end of the run")
	CmdGenerateLogs.Flags().DurationVarP(&duration, "run-duration", "d", 0, "Total duration of the run")
}
